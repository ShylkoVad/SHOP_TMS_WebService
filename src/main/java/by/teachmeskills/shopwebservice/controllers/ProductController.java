...
public class ProductController {
    ...
    public ResponseEntity<List<ProductDto>> getProductsByCategoryId(@Parameter(required = true, description = "Category ID")
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProductDto> getProductById(@Parameter(required = true, description = "Product ID")
                                                     @PathVariable int id) {
    ...
    public ResponseEntity<List<ProductDto>> getProductsBySearchParameter(@Parameter(required = true, description = "Search parameter")
